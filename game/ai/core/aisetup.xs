...
void initCivUnitTypes()
{
   ...
   if (civIsEuropean() == true)
   {
      ...
      if ((cMyCiv == cCivGermans) || (cMyCiv == cCivRussians) || (cMyCiv == cCivLBPolish) || (cMyCiv == cCivLBDanish))
      {
...
void initPersonality(void)
{
   ...
   case cCivXPSioux: // Extreme rush
   {
      ...
      case cCivLBPolish: // Extreme rush
   {
      btRushBoom = 0.8;
      if (aiRandInt(10) < 1)
      {
      ...
      case cCivLBDanish: // Guiseppe Garibaldi: Balanced.
   {
      btRushBoom = 0.5;
      if (aiRandInt(10) < 5)
      {
